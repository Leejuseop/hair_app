...
The immediate next technical step is Step 6 v05 forehead edge/detail recovery
...
the current region/guard baseline: it uses a fixed black symmetric eyebrow mask
as a protection placeholder and adds a flatter broad front-hairline lift before
v05 detail and boundary recovery.
